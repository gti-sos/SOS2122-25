...
var app = (function () {
    ...
    const file$1 = "src\\front\\frontEconomies\\economiesTable.svelte";
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th1, file$1, 34, 4, 538);
    			add_location(th2, file$1, 37, 4, 569);
    			add_location(th3, file$1, 40, 4, 606);
    			add_location(th4, file$1, 43, 4, 642);
    			add_location(tr, file$1, 30, 3, 496);
    			add_location(thead, file$1, 29, 2, 484);
    			add_location(tbody, file$1, 48, 2, 704);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t8 = text(t8_value);
    			t9 = space();
    			add_location(td0, file$1, 51, 5, 762);
    			add_location(td1, file$1, 52, 5, 795);
    			add_location(td2, file$1, 53, 5, 825);
    			add_location(td3, file$1, 54, 5, 860);
    			add_location(td4, file$1, 55, 5, 894);
    			add_location(tr, file$1, 50, 4, 751);
    		},
    		m: function mount(target, anchor) {
