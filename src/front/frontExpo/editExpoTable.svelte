<script>
    ...
    async function getEntries(){
        ...
        if(res.ok){
            ...
            updatedExpo_tec = entry.expo_tec;
            updatedExpo_m = entry.expo_m;
            updatedExpo_bys = entry.expo_bys;
        }else{
            visible = true;
            color = "danger"
        ...
        <Table bordered>
            ...
            <tbody>
                <tr>
                    ...
                    <td><input bind:value="{updatedExpo_tec}"></td>
                    <td><input bind:value="{updatedExpo_m}"></td>
                    <td><input bind:value="{updatedExpo_bys}"></td>
